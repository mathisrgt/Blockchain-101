...
async function main() {
    ...
    const erc20Address = "0x491421D72FE3Ce027307dA0205A2f7Ca3115F0cb";

    const erc20 = await ethers.getContractAt("ERC20TD", erc20Address);
    ...
    const Ex13Contract = await Ex13.deploy((erc20 as any).target);
    ...
    console.log(`Ex13Contract deployed at: ${Ex13Contract.target}`);
